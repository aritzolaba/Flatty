...
<div class="row">
    ...
    <div class="col-sm-8 col-md-8 <?php if ($flatty_theme_options['sidebar_position'] == 'left') echo 'pull-right'; ?>">
    ...
    <aside class="col-sm-4 col-md-4 <?php if ($flatty_theme_options['sidebar_position'] == 'left') echo 'pull-left'; ?>">
